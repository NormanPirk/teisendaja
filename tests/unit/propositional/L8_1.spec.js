...
describe("L8_1 tests", () => {
    ...
    test("simplifies A(x)∨A(x)∧B(y)", () => {
        ...
        expect(convert(input, "L8_1")).toBe("A(x)");
    });
    ...
    test("simplifies A∧B∨A∧B∧B", () => {
        ...
        expect(convert(input, "L8_1")).toBe("A∧B");
    });
    ...
    test("simplifies (∀xF(x)⇒H)∨(∀xF(x)⇒H)∧C", () => {
        ...
        expect(convert(input, "L8_1")).toBe("(∀xF(x)⇒H)");
    });

    test("simplifies (∃xF(x)∨((∃xF(x)∨∀yG(y)∨H(x,f(z)))∨C))∨(∃xF(x)∨((∃xF(x)∨∀yG(y)∨H(x,f(z)))∨C))∧C", () => {
        const input = "(∃xF(x)∨((∃xF(x)∨∀yG(y)∨H(x,f(z)))∨C))∨(∃xF(x)∨((∃xF(x)∨∀yG(y)∨H(x,f(z)))∨C))∧C";
        expect(convert(input, "L8_1")).toBe("(∃xF(x)∨((∃xF(x)∨∀yG(y)∨H(x,f(z)))∨C))");
    });
