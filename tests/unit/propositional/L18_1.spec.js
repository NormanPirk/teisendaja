...
describe("L18_1 tests", () => {
    ...
    test("turns equivalence to disjunction of implications A(x)∧C(t)⇔B(y,f(z))", () => {
        ...
        expect(convert(input, "L18_1")).toBe("(A(x)∧C(t)⇒B(y,f(z)))∧(B(y,f(z))⇒A(x)∧C(t))");
    });
