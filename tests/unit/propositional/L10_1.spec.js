...
describe("L10_1 tests", () => {
    ...
    test("applies the distributive property to A(x)∨B(x)∧C(y)", () => {
        ...
        expect(convert(input, "L10_1")).toBe("(A(x)∨B(x))∧(A(x)∨C(y))");
    });
