...
describe("L16_2 tests", () => {
  test("implication to disjunction ¬F⇒G", () => {
    const input = "¬F⇒G";
    expect(convert(input, "L16_2")).toBe("F∨G");
  });

  test("implication to disjunction ¬A(x)⇒B(y,f(z))", () => {
