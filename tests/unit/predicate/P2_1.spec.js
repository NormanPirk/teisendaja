...
describe("P2_1 tests", () => {
  ...
  test("returns null if the input is not in the form of ¬∃xF(x)", () => {
    ...
    expect(convert(input, "P2_1")).toBe(null);
  });
