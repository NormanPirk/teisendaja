...
import ColorParensVisitor, { colors, index, increaseIndex, resetIndex } from "@/ANTLR/leftAssocGrammar/visitors/coloringParens/ColorParensVisitor.js";
...
describe("Coloring parentheses around expression", () => {
    ...
    test("adds color to parentheses around (¬∀xF(x)∧B∨C⇔∃yD(y)⇒H∧1∧0)", () => {
        ...
        expect(visitor.visit(tree)).toBe("<span style='color:#e39e21;font-weight:bold;'>(</span>¬∀xF(x)∧B∨C⇔∃yD(y)⇒H∧1∧0<span style='color:#e39e21;font-weight:bold;'>)</span>");
        resetIndex();
    });
